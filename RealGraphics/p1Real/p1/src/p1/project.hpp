...
class OpenglProject
{
   ...
   void calculateNormalH();
   void updateHeightMesh();
   ...
   Vector3 *masterNormal;

   int NUMVERTS;
   int numHeightVerts;
   int numHeightIndicies;

   Vector3 *masterHNormTotal;

   Vector3 *masterHeightMap;
   unsigned int *masterHIndex;
   Vector3 *masterHeightNorm;
